...
import models.responsemodels.UserResponse;
import org.hamcrest.MatcherAssert;
import rest.httpclient.UserHTTPClient;

import static org.hamcrest.CoreMatchers.equalTo;

public class UserSteps extends UserHTTPClient {
    ...
    public void checkUser(Response response, String expectedMail, String expectedPassword, String expectedName) {
        ...
        new CheckResponseSteps().checkStatusCode(loginUser(expectedMail, expectedPassword), 200);
    }
